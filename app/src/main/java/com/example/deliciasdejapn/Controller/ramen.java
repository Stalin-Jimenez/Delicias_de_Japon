...
public class ramen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listadatos=findViewById(R.id.Ramen);

        Conexion dbHelper = new Conexion(this);
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor c = db.rawQuery("select * from tb_comida where nombre='Ramen'", null);
        datos=new ArrayList<>();
        if(c!=null){
            c.moveToFirst();
            do {
    ...
    public void Pedido(View view) {
        ...
        String Mensaje="Hola! muy buenas me gustaria hacer un pedido de Ramen";
